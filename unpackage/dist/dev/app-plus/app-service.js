...
try {
  components = {
    ...
    compDivider: __webpack_require__(/*! @/components/comp-divider/comp-divider.vue */ 39).default,
  }
} catch (e) {
  if (
  ...
  return _c("view", [
    ...
    _c(
      "swiper",
      {
        ...
        attrs: { current: _vm._$s(3, "a-current", _vm.currentIndex), _i: 3 },
        on: { change: _vm.handleChangeSwiper },
      },
      _vm._l(
        _vm._$s(4, "f", { forItems: _vm.tabBars }),
          ...
          return _c(
            ...
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s("5-" + $31, "sc", "swiper-item"),
                  attrs: { _i: "5-" + $31 },
                },
                [
                  _c(
                    ...
                    [
                      _vm._l(
                        _vm._$s(7 + "-" + $31, "f", { forItems: _vm.list }),
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = {\n  data: function data() {\n    return {\n      id: 0,\n      currentIndex: 0,\n      scrollH: 0,\n      scrollInto: 0,\n      activeTab: 0,\n      // tabbar数据\n      tabBars: [],\n      // 帖子列表数据\n      list: []\n    };\n  },\n  onLoad: function onLoad() {\n    this.getHeight();\n    this.getTabBar();\n  },\n  methods: {\n    // 获取tabbar数据\n    getTabBar: function getTabBar() {\n      var _this = this;\n      uni.request({\n        url: 'https://sqapi.2yuecloud.com/api/v1/postclass',\n        method: \"GET\",\n        success: function success(res) {\n          _this.tabBars = res.data.data.list;\n          _this.id = _this.tabBars[0].id;\n          _this.getPostList();\n        }\n      });\n    },\n    // 获取帖子列表数据\n    getPostList: function getPostList() {\n      var _this2 = this;\n      uni.request({\n        url: 'https://sqapi.2yuecloud.com/api/v1/postclass/' + this.id + '/post/1',\n        method: 'GET',\n        success: function success(res) {\n          __f__(\"log\", \"res=>\", res, \" at pages/index/index.vue:71\");\n          _this2.list = res.data.data.list;\n        }\n      });\n    },\n    // 获取可使用窗口高度\n    getHeight: function getHeight() {\n      var _this3 = this;\n      uni.getSystemInfo({\n        success: function success(res) {\n          __f__(\"log\", \"res=>\", res, \" at pages/index/index.vue:80\");\n          _this3.scrollH = res.windowHeight - uni.upx2px(100);\n        }\n      });\n    },\n    // tab切换\n    handleChangeTab: function handleChangeTab(index) {\n      this.activeTab = index;\n      this.scrollInto = 'tab' + index;\n      this.currentIndex = index;\n      this.id = this.tabBars[index].id;\n      this.getPostList();\n    },\n    // swiper切换触发的方法\n    handleChangeSwiper: function handleChangeSwiper(e) {\n      this.currentIndex = e.detail.current;\n      this.handleChangeTab(this.currentIndex);\n      this.id = this.tabBars[index].id;\n      this.getPostList();\n    },\n    // 关注操作\n    handleIsFollow: function handleIsFollow(index) {\n      this.list[index].isFollow = !this.list[index].isFollow;\n      uni.showToast({\n        title: '关注成功',\n        icon: 'none'\n      });\n    },\n    // 顶/踩操作\n    handleSupport: function handleSupport(e) {\n      // 获取当前操作的数据(点击按钮对应的数据)\n      var item = this.list[e.index];\n      var msg = e.type === 'support' ? '支持' : '反对';\n      // 当前所点击的帖子是否被顶/踩过, 如果没有被顶/踩,我们在第一次点击的时候, 就应该让对应的类型数字++\n      if (item.support.type === \"\") {\n        item.support[e.type + '_count']++;\n      } else if (item.support.type === 'support' && e.type === 'unsupport') {\n        // 顶 -1\n        item.support.support_count--;\n        // 踩 +1\n        item.support.unsupport_count++;\n      } else if (item.support.type === 'unsupport' && e.type === 'support') {\n        // 顶 +1\n        item.support.support_count++;\n        // 踩 -1\n        item.support.unsupport_count--;\n      }\n      item.support.type = e.type;\n      uni.showToast({\n        title: msg,\n        icon: 'none'\n      });\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 31)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///11\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _news_vue_vue_type_template_id_4274b536_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./news.vue?vue&type=template&id=4274b536&mpType=page */ 14);\n/* harmony import */ var _news_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./news.vue?vue&type=script&lang=js&mpType=page */ 16);\n/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _news_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__) if([\"default\"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _news_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));\n/* harmony import */ var _Applications_HBuilderX_app_Contents_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../../Applications/HBuilderX.app/Contents/HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 12);\n\nvar renderjs\n\n\n\n\n/* normalize component */\n\nvar component = Object(_Applications_HBuilderX_app_Contents_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\n  _news_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  _news_vue_vue_type_template_id_4274b536_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"render\"],\n  _news_vue_vue_type_template_id_4274b536_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"staticRenderFns\"],\n  false,\n  null,\n  null,\n  null,\n  false,\n  _news_vue_vue_type_template_id_4274b536_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"components\"],\n  renderjs\n)\n\ncomponent.options.__file = \"pages/news/news.vue\"\n/* harmony default export */ __webpack_exports__[\"default\"] = (component.exports);//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///13\n");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n//\n//\n//\n//\n//\n//\nvar _default = {\n  data: function data() {\n    return {};\n  },\n  methods: {}\n};\nexports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///22\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _my_vue_vue_type_template_id_1cc45dd4_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my.vue?vue&type=template&id=1cc45dd4&mpType=page */ 24);\n/* harmony import */ var _my_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my.vue?vue&type=script&lang=js&mpType=page */ 26);\n/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _my_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__) if([\"default\"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _my_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));\n/* harmony import */ var _Applications_HBuilderX_app_Contents_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../../Applications/HBuilderX.app/Contents/HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 12);\n\nvar renderjs\n\n\n\n\n/* normalize component */\n\nvar component = Object(_Applications_HBuilderX_app_Contents_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\n  _my_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  _my_vue_vue_type_template_id_1cc45dd4_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"render\"],\n  _my_vue_vue_type_template_id_1cc45dd4_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"staticRenderFns\"],\n  false,\n  null,\n  null,\n  null,\n  false,\n  _my_vue_vue_type_template_id_1cc45dd4_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"components\"],\n  renderjs\n)\n\ncomponent.options.__file = \"pages/my/my.vue\"\n/* harmony default export */ __webpack_exports__[\"default\"] = (component.exports);//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///23\n");
          ...
          _c(
            ...
            [
              _c("image", {
                ...
                attrs: {
                  src: _vm._$s(3, "a-src", _vm.item.user.userpic),
                  _i: 3,
                },
              ...
              _c("view", [
                _c(
                  ...
                  [_vm._v(_vm._$s(5, "t0-0", _vm._s(_vm.item.user.username)))]
                ),
                _c(
                  "text",
                  {
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default2 = {\n  name: \"comp-post\",\n  props: {\n    item: {\n      type: Object,\n      default: function _default() {}\n    },\n    index: {\n      type: Number,\n      default: 0\n    }\n  },\n  data: function data() {\n    return {};\n  },\n  methods: {\n    // 打开个人空间\n    handleOpenSpace: function handleOpenSpace() {\n      __f__(\"log\", '打开个人空间', \" at components/comp-post/comp-post.vue:73\");\n    },\n    // 跳转到帖子详情页\n    handleOpenDetail: function handleOpenDetail() {\n      __f__(\"log\", \"跳转到帖子详情页\", \" at components/comp-post/comp-post.vue:77\");\n    },\n    // 顶/踩操作\n    handleDoSupport: function handleDoSupport(type, index) {\n      this.$emit(\"support\", {\n        type: type,\n        index: index\n      });\n    },\n    // 关注功能\n    handleIsFollow: function handleIsFollow(index) {\n      this.$emit(\"follow\", index);\n    }\n  }\n};\nexports.default = _default2;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 31)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///38\n");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n//\n//\n//\n//\nvar _default = {\n  name: \"comp-divider\",\n  data: function data() {\n    return {};\n  }\n};\nexports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///43\n");
